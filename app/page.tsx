  ...
  return (
    <div className='home'>
      ...
      <div className='section2 border-y-black border-y-[7px] border-y-solid py-[175px] px-[152px]'>
        <Image src={GreenBadge} width={250} height={250} alt='green badge' className="absolute right-0 top-[100vh]"/>
        ...
        <Image src={PinkLogo} width={276} height={177} alt='pink logo' className="absolute left-20 mt-20"/>
      </div>
    </div>
  );
}
