  ...
  return (
    ...
    >
      ...
      <div className='relative mt-1 h-[.8px] w-full'>
        <div
          className={cn(
            "absolute left-0 top-0 h-full w-full bg-neonPink transition-transform duration-300",
            isHoveredIn
        ...
        <div
          className={cn(
            "absolute left-0 top-0 h-full w-full translate-x-0 transform bg-neonPink opacity-0 transition-transform duration-300",
